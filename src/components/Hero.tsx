      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8 max-w-2xl leading-relaxed">
            Automatiza reservas, genera cotizaciones y controla costos con nuestro sistema integral 
            diseñado específicamente para Vamos Expeditions.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 px-8 py-4 text-lg backdrop-blur-sm"
            >
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-primary-foreground/80">Reservas Automatizadas</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary-foreground mb-2">95%</div>
              <div className="text-primary-foreground/80">Reducción de Errores</div>
            </div>
            <div className="text-center">
